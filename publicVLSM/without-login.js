...
const toggleNavigation = document.querySelector(".container");

// when the user enter the ip address
let enter = document.getElementById("enter");
enter.addEventListener("click", () => {
  //toggleNavigation.classList.toggle("hide");
  //validateIP();
  updateCIDR();
});
...
function addNet() {
  ...
  document.getElementById("calculate").style.backgroundColor = "#645cff";
  updateNets();
}
